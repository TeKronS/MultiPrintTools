...
export const translations = {
  en: {
    ...
    heroDesc: 'Optimize your workflow with our collection of utilities specifically designed for copy centers, graphic arts, and office work.',
    support: 'Support',
  ...
  es: {
    ...
    heroDesc: 'Optimiza tu flujo de trabajo con nuestra colección de utilidades diseñadas específicamente para centros de copiado, artes gráficas y trabajo de oficina.',
    support: 'Soporte',
