          ...
          {!image ? (
            <div className="max-w-lg w-full px-6 lg:p-8 animate-fade-in text-center flex flex-col gap-6 lg:gap-8 my-auto">
              ...
              <div className="order-2 space-y-2">
                <h2 className="text-2xl lg:text-3xl font-headline font-black tracking-tighter">{lang === 'es' ? 'Preparar nuevo poster' : 'Prepare new poster'}</h2>
          ...
          <Sheet open={isMenuOpen} onOpenChange={handleMenuOpenChange}>
            ...
            >
              <SheetHeader className="sr-only">
                ...
                <SheetDescription>Panel de ajustes para la cuadrícula del poster</SheetDescription>
              </SheetHeader>
