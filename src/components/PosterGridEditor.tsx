  ...
  return (
    <div className="flex flex-col min-h-svh w-full font-body bg-background text-foreground overflow-x-hidden">
      ...
      <main className="flex-1 flex overflow-hidden relative">
        ...
        <aside className="hidden lg:block w-80 border-l border-border bg-background overflow-y-auto shadow-xl z-10">{renderSettings(rows, cols, overlap, marginV, marginH, paperSize, orientation, showGuides, showOutline, targetWidth, targetHeight, physicalInfo)}</aside>
      </main>
      {image && (
